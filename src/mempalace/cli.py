    ...
    if files:
        ...
        if total > 0:
            ...
            if confirmed["people"] or confirmed["projects"]:
                ...
                with Path(entities_path).open("w", encoding="utf-8") as f:
...
def cmd_repair(args):  # noqa: PLR0915, PLR0914
...
def cmd_compress(args):  # noqa: C901, PLR0912, PLR0915, PLR0914
    ...
    print(f"\n  Compressing {len(docs)} drawers" + (f" in wing '{args.wing}'" if args.wing else "") + "...")
    print()
