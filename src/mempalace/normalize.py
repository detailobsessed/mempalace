...
def _try_codex_jsonl(content: str) -> str | None:  # noqa: C901
...
def _try_claude_ai_json(data) -> str | None:  # noqa: C901, PLR0912
...
def _try_chatgpt_json(data) -> str | None:  # noqa: C901
